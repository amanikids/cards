...
ActiveRecord::Schema.define(:version => 20101130120135) do
  ...
  add_index "transfers", ["happened_at"], :name => "index_transfers_on_happened_at"
  add_index "transfers", ["product_id"], :name => "index_transfers_on_product_id"
