...
class CartsControllerTest < ActionController::TestCase
  ...
  context 'with an existing Distributor' do
    ...
    context 'without a current cart' do
      context 'show' do
        setup { get :show, :distributor_id => @distributor }
        should_redirect_to 'distributor_root_path(@distributor)'
      end

      context 'update' do
        setup { put :update, :distributor_id => @distributor }
        should_redirect_to 'distributor_root_path(@distributor)'
      end
    end
    ...
    context 'with a non-empty current cart' do
      ...
      context 'when update_items succeeds' do
        ...
        context 'update' do
          setup { put :update, :items => :item_attributes, :distributor_id => @distributor }
      ...
      context 'when update_items fails' do
        ...
        context 'update' do
          setup { put :update, :items => {}, :distributor_id => @distributor }
          should_render_template 'show'
        end
      end
    end
